...
INSERT INTO `auth_permission` VALUES ('19', 'Can add scene space', '7', 'add_scenespace');
INSERT INTO `auth_permission` VALUES ('20', 'Can change scene space', '7', 'change_scenespace');
INSERT INTO `auth_permission` VALUES ('21', 'Can delete scene space', '7', 'delete_scenespace');
INSERT INTO `auth_permission` VALUES ('22', 'Can add space', '8', 'add_space');
INSERT INTO `auth_permission` VALUES ('23', 'Can change space', '8', 'change_space');
INSERT INTO `auth_permission` VALUES ('24', 'Can delete space', '8', 'delete_space');
...
INSERT INTO `auth_permission` VALUES ('28', 'Can add hot', '10', 'add_hot');
INSERT INTO `auth_permission` VALUES ('29', 'Can change hot', '10', 'change_hot');
INSERT INTO `auth_permission` VALUES ('30', 'Can delete hot', '10', 'delete_hot');
INSERT INTO `auth_permission` VALUES ('31', 'Can add scene', '11', 'add_scene');
INSERT INTO `auth_permission` VALUES ('32', 'Can change scene', '11', 'change_scene');
INSERT INTO `auth_permission` VALUES ('33', 'Can delete scene', '11', 'delete_scene');
...
INSERT INTO `django_content_type` VALUES ('10', 'panorama', 'hot');
INSERT INTO `django_content_type` VALUES ('11', 'panorama', 'scene');
INSERT INTO `django_content_type` VALUES ('7', 'panorama', 'scenespace');
INSERT INTO `django_content_type` VALUES ('9', 'panorama', 'seller');
INSERT INTO `django_content_type` VALUES ('8', 'panorama', 'space');
...
-- ----------------------------
INSERT INTO `django_migrations` VALUES ('1', 'contenttypes', '0001_initial', '2017-02-10 03:44:03.022388');
INSERT INTO `django_migrations` VALUES ('2', 'auth', '0001_initial', '2017-02-10 03:44:06.618373');
INSERT INTO `django_migrations` VALUES ('3', 'admin', '0001_initial', '2017-02-10 03:44:07.771194');
INSERT INTO `django_migrations` VALUES ('4', 'admin', '0002_logentry_remove_auto_add', '2017-02-10 03:44:07.790199');
INSERT INTO `django_migrations` VALUES ('5', 'contenttypes', '0002_remove_content_type_name', '2017-02-10 03:44:08.475814');
INSERT INTO `django_migrations` VALUES ('6', 'auth', '0002_alter_permission_name_max_length', '2017-02-10 03:44:09.233981');
INSERT INTO `django_migrations` VALUES ('7', 'auth', '0003_alter_user_email_max_length', '2017-02-10 03:44:09.560254');
INSERT INTO `django_migrations` VALUES ('8', 'auth', '0004_alter_user_username_opts', '2017-02-10 03:44:09.578271');
INSERT INTO `django_migrations` VALUES ('9', 'auth', '0005_alter_user_last_login_null', '2017-02-10 03:44:09.787028');
INSERT INTO `django_migrations` VALUES ('10', 'auth', '0006_require_contenttypes_0002', '2017-02-10 03:44:09.810048');
INSERT INTO `django_migrations` VALUES ('11', 'auth', '0007_alter_validators_add_error_messages', '2017-02-10 03:44:09.834093');
INSERT INTO `django_migrations` VALUES ('12', 'auth', '0008_alter_user_username_max_length', '2017-02-10 03:44:10.119280');
INSERT INTO `django_migrations` VALUES ('13', 'panorama', '0001_initial', '2017-02-10 03:44:14.718932');
INSERT INTO `django_migrations` VALUES ('14', 'sessions', '0001_initial', '2017-02-10 03:44:14.957059');
...
CREATE TABLE `panorama_hot` (
  ...
  PRIMARY KEY (`id`),
  KEY `panorama_hot_eb8511ca` (`scene_space_id`),
...
INSERT INTO `panorama_hot` VALUES ('17', '下一个', '{\"vy\": -20.3823, \"vz\": 37.65, \"vx\": -13.8578}', '{\"to\": \"19\", \"pz\": -59.6248, \"px\": 11.352, \"py\": -1.1775}', '17');
INSERT INTO `panorama_hot` VALUES ('18', '下一个', '{\"vy\": -6.9236, \"vz\": 31.6381, \"vx\": -31.2425}', '{\"to\": \"21\", \"px\": 105.6778, \"pz\": -103.861, \"py\": -3.1311}', '18');
INSERT INTO `panorama_hot` VALUES ('19', '下一个', '{\"vy\": -12.3058, \"vz\": 17.1798, \"vx\": -39.7293}', '{\"to\": \"20\", \"px\": 149.1104, \"pz\": -46.5329, \"py\": 3.3948}', '18');
...
INSERT INTO `panorama_hot` VALUES ('26', '666666666', '{\"vy\": -16.1409, \"vz\": -13.6867, \"vx\": -39.7133}', '{\"to\": \"19\", \"px\": 109.6682, \"pz\": 2.4649, \"py\": -31.0354}', '14');
INSERT INTO `panorama_hot` VALUES ('27', '回', '{\"vy\": -32.346, \"vz\": -31.1592, \"vx\": 2.8}', '{\"pz\": 61.6089, \"px\": -6.8872, \"py\": -0.0785, \"to\": \"22\"}', '16');
INSERT INTO `panorama_hot` VALUES ('28', '进入3空间', '{\"vy\": -29.3776, \"vz\": 32.0874, \"vx\": -11.5046}', '{\"to\": \"17\", \"pz\": -82.5228, \"px\": 12.6951, \"py\": -0.8434}', '21');
INSERT INTO `panorama_hot` VALUES ('29', '下一个场景', '{\"vy\": -16.4163, \"vz\": 41.4268, \"vx\": 6.2707}', '{\"to\": \"16\", \"px\": -31.3875, \"pz\": -101.6197, \"py\": -1.7537}', '16');
...
INSERT INTO `panorama_hot` VALUES ('34', '进入空间2', '{\"vx\": 2.4612, \"vy\": -11.9136, \"vz\": 43.3245}', '{\"to\": \"16\", \"pz\": -115.7217, \"px\": -22.6009, \"py\": -1.6234}', '21');
...
CREATE TABLE `panorama_scene` (
  ...
  PRIMARY KEY (`id`),
  KEY `panorama_scene_b64a62ea` (`entry_id`),
  KEY `panorama_scene_0a7c7ff2` (`seller_id`),
...
CREATE TABLE `panorama_scenespace` (
  ...
  KEY `panorama_scenespace_84defa73` (`space_id`),
...
-- ----------------------------
INSERT INTO `panorama_seller` VALUES ('1', '萧山建材城', 'seller-logo/logo.png', '0751-67652213', '杭州市萧山经济开发区启迪路198号杭州湾信息港B座', '商家描述。', '2016-10-05 06:48:05.472000');
